...
function () {
  ...
  _createClass(LazyLinePainter, [{
    ...
    value: function _paint() {
      ...
      var progress = this.config.elapsedTime / this.config.totalDuration;
      this.config.progress = this._getProgress(progress, this.config.ease); // console.log(this.config.elapsedTime, ' ', this.config.totalDuration);
...
//# sourceMappingURL=lazy-line-painter-1.9.1.js.map