...
function () {
  ...
  _createClass(LazyLinePainter, [{
    ...
    value: function paint() {
      ...
      return this._initialised.then(function () {
        _this.erase(); // begin animation


        _this.__raf = requestAnimationFrame(function (timestamp) {
    ...
    key: "_setupPaths",
    value: function _setupPaths(resolve, reject) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        for (var _i4 = 0; _i4 < _this3.config.paths.length; _i4++) {
          var path = _this3.config.paths[_i4];
          path.index = _i4;
          path.length = _this3._getPathLength(path.el);
          path.positions = _this3._getPathPoints(path.el, path.length);
          path.el.style.strokeDashoffset = path.length;
    ...
    value: function _calcPathDurations() {
      var startTime = this.config.reverse ? this.config.totalDuration : this.config.delay;
    ...
    value: function _updatePaths() {
      for (var _i6 = 0; _i6 < this.config.paths.length; _i6++) {
        var path = this.config.paths[_i6];
    ...
    key: "_getProgress",
    value: function _getProgress(duration, start, elapsed, ease, path) {
      var progress;
    ...
    value: function _getTotalDuration() {
      ...
      for (var _i7 = 0; _i7 < paths.length; _i7++) {
        ...
        totalDuration += paths[_i7].duration + pathDelay;
      }
    ...
    value: function _getLongestDuration() {
      ...
      for (var _i8 = 0; _i8 < paths.length; _i8++) {
        var pathTotalDuration = paths[_i8].delay + paths[_i8].duration;
    ...
    value: function _getPathPoints(el, length) {
      ...
      for (var _i9 = 0; _i9 < length; _i9++) {
        var position = el.getPointAtLength(_i9);
        arr.push({
          x: position.x,
          y: position.y
        });
    ...
    value: function _getStrokeDashString(dashArray, length) {
      ...
      for (var _i10 = strokeDashArray.length - 1; _i10 >= 0; _i10--) {
        strokeDashTotal += Number(strokeDashArray[_i10]);
      }
      ...
      for (var _i11 = strokeDashNum - 1; _i11 >= 0; _i11--) {
