  ...
  _createClass(LazyLinePainter, [{
    ...
    value: function _setupPaths() {
      ...
      for (var i = 0; i < this.options.paths.length; i++) {
        ...
        path.el.getBoundingClientRect(); // path.onStrokeStart = path.onStrokeStart || null;
     ...
     */
    value: function _getPath(data) {
      var path = this.el.querySelector('[data-entity-id=' + data.id + ']');
...
//# sourceMappingURL=lazylinepainter-1.9.0.js.map