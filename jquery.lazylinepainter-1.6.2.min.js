...
(function(h){var q={init:function(b){return this.each(function(){var c=h(this),a=c.data("lazyLinePainter");c.addClass("lazy-line");if(!a){var a=h.extend({width:null,height:null,strokeWidth:2,strokeColor:"#000",strokeOverColor:null,strokeCap:"round",strokeJoin:"round",strokeOpacity:1,onComplete:null,onUpdate:null,onStart:null,onStrokeStart:null,onStrokeComplete:null,delay:0,overrideKey:null,drawSequential:!0,speedMultiplier:1,reverse:!1,responsive:!1},b),e=a.overrideKey?a.overrideKey:c.attr("id").replace("#",
""),d=a.svgData[e].dimensions.width,k=a.svgData[e].dimensions.height;a.paths=h.extend(!0,[],a.svgData[e].strokepath);null===a.width&&(a.width=d);null===a.height&&(a.height=k);a.responsive||c.css({width:a.width,height:a.height});e="0 0 "+d+" "+k;d=document.createElementNS("http://www.w3.org/2000/svg","svg");d.setAttributeNS(null,"viewBox",e);d.setAttribute("xmlns","http://www.w3.org/2000/svg");e=h(d);a.svg=e;c.append(a.svg);a.longestDuration=0;for(var g=a.playhead=0,d=e=a.delay*a.speedMultiplier,k=
k=0;k<a.paths.length;k++)g=a.paths[k].duration*a.speedMultiplier,d+=g;for(k=0;k<a.paths.length;k++){var l;l=a;var m=k,f=document.createElementNS("http://www.w3.org/2000/svg","path"),g=h(f);l.svg.append(g);g.attr(u(l,l.paths[m]));l=f;m=Math.ceil(l.getTotalLength());f=a.paths[k];f.positions=[];for(g=0;g<m;g++){var n=l.getPointAtLength(g);f.positions.push({x:n.x,y:n.y})}l.style.strokeDasharray=m+" "+m;l.style.strokeDashoffset=m;l.style.display="block";l.getBoundingClientRect();g=f.duration*a.speedMultiplier;
g>a.longestDuration&&(a.longestDuration=g);n=a.reverse?d-=g:a.playhead+e;f.duration=g;f.drawStartTime=n;f.el=l;f.index=k;f.length=m;f.progress=0;f.onStrokeStart=f.onStrokeStart||null;f.onStrokeComplete=f.onStrokeComplete||null;f.onStrokeStartDone=!1;f.onStrokeCompleteDone=!1;f.onStrokeUpdate=f.onStrokeUpdate||null;a.playhead+=g}a.totalDuration=a.drawSequential?a.playhead:a.longestDuration;a.totalDuration+=e;c.data("lazyLinePainter",a);c.lazylinepainter("resize")}})},paint:function(){return this.each(function(){var b=
h(this).data("lazyLinePainter");setTimeout(function(){b.rAF=requestAnimationFrame(function(c){p(c,b)});if(null!==b.onStart)b.onStart()},b.delay)})},pauseResume:function(){return this.each(function(){var b=h(this).data("lazyLinePainter");b.paused?(b.paused=!1,requestAnimationFrame(function(c){v(c,b)})):(b.paused=!0,cancelAnimationFrame(b.rAF))})},erase:function(){return this.each(function(){var b=h(this).data("lazyLinePainter");b.startTime=null;b.elapsedTime=null;cancelAnimationFrame(b.rAF);b.onStrokeCompleteDone=
!1;for(var c=0;c<b.paths.length;c++){var a=b.paths[c];a.el.style.strokeDashoffset=a.length;a.onStrokeCompleteDone=!1;a.onStrokeStartDone=!1}})},destroy:function(){return this.each(function(){var b=h(this);b.removeData("lazyLinePainter");b.remove()})},set:function(b){return this.each(function(){var c=h(this).data("lazyLinePainter");c.elapsedTime=b*c.totalDuration;r(c)})},get:function(){return h(this).data("lazyLinePainter")},resize:function(){this.each(function(){var b=h(this),c=b.data("lazyLinePainter");
